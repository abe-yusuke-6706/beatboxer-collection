...
ActiveRecord::Schema[7.2].define(version: 2025_07_21_060830) do
  ...
  create_table "tag_realations", force: :cascade do |t|
    t.bigint "post_id", null: false
    t.bigint "tag_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_tag_realations_on_post_id"
    t.index ["tag_id"], name: "index_tag_realations_on_tag_id"
  end
  ...
  add_foreign_key "tag_realations", "posts"
  add_foreign_key "tag_realations", "tags"
